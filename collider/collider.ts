...
import { CollisionPriority } from "./collisionPriority.js";
    ...
    */
    ...
    collide()
    {
        this.objectpull.forEach(object => {
            ...
            if(object.collision_priority != CollisionPriority.DISABLED && object.collision_priority != CollisionPriority.STATIC)
            {
                this.objectpull.forEach(collided => {
                    if(collided.id != object.id && (collided.collision_priority != CollisionPriority.DISABLED)){
