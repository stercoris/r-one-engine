import {Entity, EntityAnimation, FrameWH, Frame} from "./entities.js"
import { Collision, CollisionPriority, Directions } from "../collider/collisions.js"
...
export class InteractiveEntity extends Entity
{
    ...
    addImpact(
        ...
        else if(directionH == Directions.RIGHT && this.accelerationX < this.max_speed)
            this.accelerationX += accelerationX

        if(directionV == Directions.TOP && this.accelerationY > -this.max_speed)
            this.accelerationY -= accelerationY
        else if(directionV == Directions.BOTTOM && this.accelerationY < this.max_speed)
            this.accelerationY += accelerationY 
    ...
    draw(context: CanvasRenderingContext2D)
    {
        ...
        this.position.y += this.accelerationY += this.move(this.accelerationY);// + this.gravity
