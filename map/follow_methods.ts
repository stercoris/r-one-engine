...
import { Frame } from "../entity/frame.js";

export class FollowParams
{
    constructor(
        private game_area: Frame,
        public follow_method: FollowMehod
    )
    {}   
    ...
    isInGameArea(pointer: Entity): Directions
    {
        ...
        else if(pointer.getBottom() > this.game_area.y_end) return(Directions.BOTTOM);
