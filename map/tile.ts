...
import { Frame, FrameWH } from "../entity/entities.js"
...
class Tile extends Frame
{
    ...
    */
    constructor(x: number, y: number, x_end: number, y_end: number, collision_priority: CollisionPriority, symbol: string)
    {   
...
class TileWH extends Tile
{
     ...
     * @param {string} symbol символ тайла
    */
    constructor(x: number, y: number, w: number, h: number, collision_priority: CollisionPriority, symbol: string)
    {   
